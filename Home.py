...
st.write("If you want candlestick patterns on say 25th aug 2025 to 28th aug 2025")
st.write("then select from date : 25th aug 2025")
st.write("then select to date : 29th aug 2025 [to get results for 28th aug 2025]")
